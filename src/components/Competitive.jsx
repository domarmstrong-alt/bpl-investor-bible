const rows = [
  { name: 'Blue Paper Labs', price: '£150/mo full suite', target: 'Independent 1–5 venues, Square/Lightspeed/Toast', ai: '✓ Claude API', pos: 'Square · Lightspeed · Toast (Y1–2)', haccp: '✓', uk: '✓', highlight: true },
    ...
    <section id="competition" className="section" data-animate>
      ...
      <div className="callout" data-animate>
        ...
        <p style={{ fontSize: 14, lineHeight: 1.7, color: '#1B2A4A' }}>
          On 2 April 2026, Square launched 'Square Restaurant Inventory by MarketMan' globally including the UK and Ireland — confirming the market opportunity. The total cost for an operator: £69/month (Square for Restaurants Plus) + £79/month (MarketMan add-on) = £148/month per location. For £2/month more than the MarketMan bundle, operators get inventory PLUS compliance, workforce management, bookings, finance, and CRM — the Blue Paper Labs suite at £150/month, with compliance features MarketMan does not offer, across Square, Lightspeed, and Toast. MarketMan has also integrated with Lightspeed and Toast for years — but at £148/month for Square users alone, and with a 2.4★ Trustpilot rating, UK and Irish operators deserve a purpose-built answer. Toast's December 2025 Dublin expansion confirms the Irish market is validated and moving. Blue Paper Labs' compliance-first positioning differentiates it from Toast's enterprise-oriented stack.
        </p>
