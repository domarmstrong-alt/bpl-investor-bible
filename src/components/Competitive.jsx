const rows = [
  { name: 'Bluepaper Limited', price: '£100/mo base · Aoife™ included · add-ons from +£10/mo', target: 'Independent 1–5 venues, Square/Lightspeed/Toast', ai: '✓ Claude API', pos: 'Square · Lightspeed · Toast (Y1–2)', haccp: '✓', uk: '✓', highlight: true },
