const headlines = [
  ...
  { number: '£9.4m', label: '5-year cumulative subscription revenue, based on average in-year active venues rather than end-of-year ARR' },
